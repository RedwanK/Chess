...
public class GuiFactory {
	...
	public final static ObjectProperty<Color> blackSquareColorProperty() {		
		return blackSquareColor;
	}
	public final static ObjectProperty<Color> whiteSquareColorProperty() {		
		return whiteSquareColor;
	}
	public final static ObjectProperty<PaintStyle> paintStyleProperty() {		
		return paintStyle;
	}
